...
{
    public partial class frm_Themmoi_PhieuTrathuocThuatuKhoBNNoitruveKhoLeNoitru : Form
    {
        ...
        public frm_Themmoi_PhieuTrathuocThuatuKhoBNNoitruveKhoLeNoitru(string KIEU_THUOC_VT)
        {
            InitializeComponent();
        ...
        void Initevents()
        {
            ...
            this.KeyDown += new KeyEventHandler(frm_Themmoi_PhieuTrathuocThuatuKhoBNNoitruveKhoLeNoitru_KeyDown);
        ...
        void frm_Themmoi_PhieuTrathuocThuatuKhoBNNoitruveKhoLeNoitru_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_Themmoi_PhieuTrathuocThuatuKhoBNNoitruveKhoLeNoitru_Load(object sender, EventArgs e)
        {
        ...
        private TPhieuNhapxuatthuoc CreatePhieuNhapKho()
        {
            ...
            objTPhieuNhapxuatthuoc.LoaiPhieu = (byte)LoaiPhieu.PhieuTrathuocTukhoBNNoitruVeKhoLeNoitru;
            objTPhieuNhapxuatthuoc.TenLoaiphieu = Utility.TenLoaiPhieu(LoaiPhieu.PhieuTrathuocTukhoBNNoitruVeKhoLeNoitru);
